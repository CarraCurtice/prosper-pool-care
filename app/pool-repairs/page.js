...
export const metadata = {
  ...
  description:
    "Pool equipment repair and filter deep-cleans in Prosper, TX, including pumps, cartridge filters, timers, freeze protection, and pad leaks. Honest repair-vs-replace advice.",
...
const faqItems = [
  ...
  },
  {
    ...
    a: "Yes. Pad plumbing, including unions, valves, pump seals, and filter tank o-rings, is core work for us. In-ground shell or underground line leaks need a specialty leak-detection outfit, and we'll tell you honestly when that's what you're looking at.",
  },
];
  ...
  return (
    <>
      ...
      <section className="band">
        <div className="wrap">
          <Faq items={faqItems} />
          <PhoneCta line="Describe the symptom and we'll tell you what it probably is:" />
        </div>
      </section>
    </>
  );
