...
const areas = [
  ...
  {
    name: "Whitley Place",
    note: "Wooded lots along the Wilson Creek corridor, built 2008–2017. The mature canopy is beautiful and relentless, with the highest debris loads in town, and original equipment is now hitting replacement age.",
  },
  {
    name: "Lakes of La Cima",
    note: "One of Prosper's established master-planned communities, east of Preston. Pools here are among the town's older stock, so filter rebuilds and repair-vs-replace calls are routine.",
  },
  {
    name: "Gentle Creek Estates",
    note: "Larger custom lots around the golf course on the east side. Custom pools with varied equipment setups, from DE filters to water features and in-floor cleaning, that reward a tech who reads the pad before touching it.",
  },
  {
...
const faqItems = [
  ...
  },
  {
    ...
    a: "The route stays tight so service days hold. For addresses right on the edge, like the Celina side of Frontier Parkway or west toward the tollway, call and we'll tell you straight whether it fits.",
  },
];
